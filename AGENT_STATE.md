...
| F3 | Mean-reversion anchor schema manifest includes field names and field types for downstream DTO parity without `liq-scan` imports | ready-for-review | `src/liq/scan/persistence.py`; `tests/test_mean_reversion_persistence.py` |
